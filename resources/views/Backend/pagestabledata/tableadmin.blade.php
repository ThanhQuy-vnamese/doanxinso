...
@section('content')
    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1>Bảng người quản trị</h1>
          </div>
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="#">Home</a></li>
              <li class="breadcrumb-item active">bangquantri</li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
    ...
    $(document).ready(function(){
    	...
    	$(".btn1").click(function(){
	      ...
	      else
	      {
	      	$.ajax({
	    			type:'POST',
	    			url:"{{ route('timkiemtaikhoanadmin') }}",
	    			data:{
	    ...
	    $(".btn2").click(function(){
	      ...
	      else
	      {
	      	$.ajax({
	    			type:'POST',
	    			url:"{{ route('timkiemthongtinadmin') }}",
	    			data:{
