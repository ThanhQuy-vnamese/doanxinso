        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item active">bangkhachhang</li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
    ...
    $(document).ready(function(){
    	...
    	$(".btn1").click(function(){
	      ...
	      else
	      {
	      	$.ajax({
	    			type:'POST',
	    			url:"{{ route('timkiemtaikhoankhachhang') }}",
	    			data:{
	    ...
	    $(".btn2").click(function(){
	      ...
	      else
	      {
	      	$.ajax({
	    			type:'POST',
	    			url:"{{ route('timkiemthongtinkhachhang') }}",
	    			data:{
    ...
    $(document).ready(function(){
    	...
    	$(".btn1").click(function(){
	      ...
	      else
	      {
	      	$.ajax({
	    			type:'POST',
	    			url:"{{ route('timkiemtaikhoankhachhang1') }}",
	    			data:{
	    				value1:value1,_token:_token
	    			},
	    			success:function(data){
	    ...
	    $(".btn2").click(function(){
	      ...
	      else
	      {
	      	$.ajax({
	    			type:'POST',
	    			url:"{{ route('timkiemthongtinkhachhang1') }}",
	    			data:{
	    				value2:value2,_token:_token
	    			},
	    			success:function(data){
