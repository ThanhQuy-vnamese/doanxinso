        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item active">themkhachhang</li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
        ...
        <div class="row">
          ...
          <div class="col-md-8">
            ...
            <div class="card card-success">
              ...
              <form role="form" action="{!! route('postthemkhachhang') !!}" method="post" enctype="multipart/form-data">
                {{ csrf_field() }}
              @elseif(Auth::user()->chucvu == 'staff')
              <form role="form" action="{!! route('postthemkhachhang1') !!}" method="post" enctype="multipart/form-data">
                {{ csrf_field() }}
              @endif
                <div class="card-body">
                  ...
                  <input type="hidden" name="chucvu" value=""/>
